...
module Descope
  module Mixins
    ...
    module Common
      ...
      SESSION_COOKIE_NAME = "DS".freeze
      REFRESH_SESSION_COOKIE_NAME = "DSR".freeze

      SESSION_TOKEN_NAME = "sessionToken".freeze
      REFRESH_SESSION_TOKEN_NAME = "refreshSessionToken".freeze
      COOKIE_DATA_NAME = "cookieData".freeze

      REDIRECT_LOCATION_COOKIE_NAME = "Location".freeze
