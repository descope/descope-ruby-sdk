      ...
      module Management
        ...
        module Lists
          ...
          def create_list(name: nil, type: nil, description: nil, data: nil)
            ...
            mgmt_post(LIST_CREATE_PATH, body)
          end
